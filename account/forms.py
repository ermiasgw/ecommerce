...
class UserEditForm(forms.ModelForm):
    ...
    user_name = forms.CharField(
        label='user name',min_length=4, max_length=50, widget=forms.TextInput(
            attrs={
                'class': 'form-control mb-3', 'placeholder': 'Username', 'id': 'form-firstname', 'readonly': 'readonly'
            }
        )
    )
    ...
    first_name = forms.CharField(
        label='first name',min_length=4, max_length=50, widget=forms.TextInput(
            attrs={
                'class': 'form-control mb-3', 'placeholder': 'firstname', 'id': 'form-firstname', 'readonly': 'readonly'
            }
        )
    )
...
class RegistrationForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['email'].widget.attrs.update(
            {'class': 'form-control mb-3', 'placeholder': 'email', 'name': 'email','id': 'email' }
        )
